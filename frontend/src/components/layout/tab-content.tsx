...
const CascadeTab = lazy(() => import("#/routes/cascade-tab"));
...
export function TabContent({ conversationPath }: TabContentProps) {
  ...
  const isCascadeActive = currentPath === `${conversationPath}/cascade`;
  ...
  return (
    <div className="h-full w-full relative">
      ...
      >
        ...
        <div
          className={`absolute inset-0 ${isCascadeActive ? "block" : "hidden"}`}
        >
          <CascadeTab />
        </div>
      </Suspense>
